...
const int SC_NORMAL[] = { 75, 80, 85, 90, 95, 100, 105, 110, 115, 120, 125, 130, 135, 140, 145, 150, 155, 160, 165, 170, 175, 180, 185, 190, 195, -1 };
const int SC_COLUMNS[] = { 200, 300, 400, 500, -1 };
const int SC_REFLOW[] = { 150, 200, 300, 400, 500, -1 };
const int SC_DIRECT[] = { 33, 50, 75, 80, 90, 100, 110, 120, 130, 140, 150, 170, 200, 300, 400, 500, -1 };
...
void open_zoomer() {
	...
	dh = th + bm_pdfmode->height + menu_n_font->height + 20;
	dx = (ScreenWidth() - dw) / 2;
