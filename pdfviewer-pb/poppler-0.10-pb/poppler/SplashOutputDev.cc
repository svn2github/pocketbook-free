...
SplashOutputDev::SplashOutputDev(SplashColorMode colorModeA,
  ...
  vectorAntialias = allowAntialias &&
		      ...
		      colorMode != splashModeMono1 && colorMode != splashModeMono4;
  ...
  bitmap = new SplashBitmap(1, 1, bitmapRowPad, colorMode,
			    colorMode != splashModeMono1 && colorMode != splashModeMono4, bitmapTopDown);
...
void SplashOutputDev::setSoftMask(GfxState * /*state*/, double * /*bbox*/,
  ...
  if (!alpha && colorMode != splashModeMono1 && colorMode != splashModeMono4 && colorMode != splashModeMono8) {
