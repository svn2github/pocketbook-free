...
//	void drawWord(int x, int y, const ZLTextWord &word, int start, int length, bool addHyphenationSign);
	void drawWord(int xStart, int xEnd, int y, ZLTextWord &word, int start, int length, bool addHyphenationSign);
...
// Denis //
	...
	bool Hebrew;	
	bool PrevHebrew;
	bool PrevHebrewForLink;

public:
	bool HebrewTestWord(char *Data, int len);
