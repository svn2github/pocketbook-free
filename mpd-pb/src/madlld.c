...
static void set_frequency(long newfreq) {

	if (frequency == newfreq) return;

	if (ioctl(dspfd, SNDCTL_DSP_SPEED, &newfreq) < 0) 
	{
...
int main(int argc, char **argv)
{
	...
	while (1) {
		...
		while (mpc->state == MP_STOPPED) usleep(100000);
