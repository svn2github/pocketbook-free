/*
 * $Id: mtdchar.c,v 1.1.1.1 2004/02/04 12:56:23 laputa Exp $
 *
		     ...
		     u_int cmd, u_long arg)
{
	...
	case MEMCHMODPART:
	{
		...
		if (copy_from_user((struct mtd_info_user *)&mtd_user,
		  (struct mtd_info_user *)arg, sizeof(struct mtd_info_user)))
			return -EFAULT;

		mtd->flags = mtd_user.flags;
