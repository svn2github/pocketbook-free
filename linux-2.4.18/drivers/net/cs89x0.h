...
#define TX_AFTER_381	0x0049       /*  Tx packet after 381 bytes copied */
#define TX_AFTER_ALL	0x00c9       /*  Tx packet after all bytes copied */
#define TX_LEN_PORT	0x0006       /*  Why the 9 is extracted  by SW.LEE */
