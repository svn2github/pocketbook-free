...
/*      Global vars.
 */
char ft_src[] __initdata = "$Source: /home/cvs/s3c2410_kernel2.4.18_rel/drivers/char/ftape/lowlevel/ftape-init.c,v $";
char ft_rev[] __initdata = "$Revision: 1.1.1.1 $";
char ft_dat[] __initdata = "$Date: 2004/02/04 12:56:09 $";
