...
#if defined(CONFIG_USB_OHCI_MMSP2) || defined(CONFIG_USB_OHCI_MMSP2_MODULE)
#undef pci_unmap_single(x...)
#undef pci_map_single(x...)
#define pci_unmap_single(x...) usbh_unmap_single(x)
#define pci_map_single(x...) usbh_map_single(x)
extern dma_addr_t usbh_map_single(struct pci_dev *hwdev, void *ptr, size_t size, int direction);
extern void usbh_unmap_single(struct pci_dev *hwdev, dma_addr_t dma_addr, size_t size, int direction);
#endif
