...
/* $Id: i2c.h,v 1.2 2004/02/06 13:19:45 laputa Exp $ */
...
#define I2C_M_REV_DIR_ADDR	0x2000
	...
	//laputa modify when iic data interface the trans/receive data must be unsigned char type
	//	char *buf;		/* pointer to msg data	--remove 	*/
