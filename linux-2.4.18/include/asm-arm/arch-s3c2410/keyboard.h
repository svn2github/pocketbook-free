...
#ifndef _S3C2410_KEYBOARD_H
#define _S3C2410_KEYBOARD_H
...
#ifdef  CONFIG_SMDK_AIJI// CONFIG_S3C2410_SMDK
...
#else /* CONFIG_SMDK_AIJI */

#define k_translate(sc_,kc_,rm_)	((*(kc_)=(sc_)),1)
#define kbd_init_hw(x...)	do { } while (0)

#endif /* nCONFIG_SMDK_AIJI */

#define k_translate(sc_,kc_,rm_)        ((*(kc_)=(sc_)),1)
#define kbd_init_hw(x...)       do { } while (0)


#endif  /* _S3C2410_KEYBOARD_H */

/*
 | $Id: keyboard.h,v 1.1.1.1 2004/02/04 12:57:39 laputa Exp $
 |
 | Local Variables:
 | mode: c
 | mode: font-lock
