...
#define DEFAULTLANGUAGE "ru"
#define DEFAULTKEYBOARD "EN-RU-UA"
...
#define TEMPFONTPATH "/tmp/fonts"
#define PHOTOTEMPDIR "/tmp/photo"
...
#define USERDICTPATH USERDATA "/dictionaries"
...
#define CURRENTBOOK "/tmp/.current"
#define CURRENTBOOK_NV STATEPATH "/.current"
#define HISTORYFILE "/tmp/history.txt"
#define BOOKSHELFSTATE "/tmp/bsstate"
...
// Set screen orientation: 0=portrait, 1=landscape
...
void StretchBitmap(int x, int y, int w, int h, const ibitmap *src, int rotate);
...
void SetEventHandler(iv_handler hproc);
