...
void		GrFillRect(GR_DRAW_ID id, GR_GC_ID gc, GR_COORD x, GR_COORD y,
			GR_SIZE width, GR_SIZE height);
void		GrShowWindow(GR_DRAW_ID id, GR_GC_ID gc, GR_COORD x, GR_COORD y,
			GR_SIZE width, GR_SIZE height);
void		GrSaveImage(GR_DRAW_ID id, GR_GC_ID gc,char *pfile);
...
int		GetFrameBuffer(GR_DRAW_ID id, GR_GC_ID gc, struct ivfb *fb);
void		ReleaseFrameBuffer();
unsigned long   GrKeyState();
