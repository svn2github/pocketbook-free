...
/* ebook keypad definition */

/*
#define Asc_Top_Key		0x0400	  			
#define Asc_Bottom_Key	0x0200				
#define Asc_Right_Key  	0x0040			
#define Asc_Left_Key  	0x0004				
#define Asc_Enter_Key  	0x0020				
#define Asc_Menu_Key  	0x0008				
#define Asc_Return_Key	0x0001				
#define Asc_Delete_Key	0x0002  				
#define Asc_Music_Key	0x0010
#define Asc_Volplus_Key	0x0100
#define Asc_Volnega_Key	0x0080
*/

#define Asc_Top_Key  63490				//上移(↑)
#define Asc_Bottom_Key  63491			//下移(↓)	
#define Asc_Right_Key  63489			//右移(→)
#define Asc_Left_Key  63488				//左移(←)
#define Asc_Enter_Key  48				//確定(0)
#define Asc_Menu_Key  49				//主選單(1)
#define Asc_Return_Key  50				//返回鍵(2)
#define Asc_Delete_Key  51				//刪除(3)
#define Asc_Music_Key  52				//音樂(4)
